...
;; I just want the buffers to reflect what is on the disk,
;; particularly in the presence of git.
...
** JavaScript
#+BEGIN_SRC emacs-lisp
(org-babel-load-file (concat user-emacs-directory "emacs-javascript.org"))
#+END_SRC
