...
#+END_SRC
** Pretty symbols (experimenting with this. it might be annoying.) ((it is.))
#+BEGIN_SRC emacs-lisp
;; (when window-system
...
[[http://oremacs.com/2015/01/26/occur-dwim/][his blog post at (or emacs irrelevant)]]. It takes the current region or the symbol
