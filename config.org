...
The Doom modeline is by default a little less garish than the
spaceline modeline. Anyhow, I'm trying it out. 
...
;;              ;; '(font . (:family "Envy Code R" :foundry "ENVY" :slant normal :weight normal :height 120 :width normal))
;;              '(font . "Envy Code R-14")
;;              )
(if window-system
    (progn
  ...
  (setq org-agenda-files
        (delq nil
              (mapcar (lambda (x) (and (file-exists-p x) x))
                      '("~/Dropbox/OrgFiles/personal-agenda.org"
                        "~/Dropbox/Notes/notes.org"
                        "~/Dropbox/OrgFiles/todos.org"
                        "~/Dropbox/OrgFiles/Tasks.org"
                        "~/Dropbox/OrgFiles/people.org"
                        "~/Dropbox/OrgFiles/Archive.org"))))
#+end_src
