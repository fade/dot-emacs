...
#+BEGIN_SRC emacs-lisp
  ...
  ;; magithub is being merged into the forge package, and as of now it
  ;; is causing exceptions in the normal operations of magit, so I'm
  ;; killing this include until I can research forge.
